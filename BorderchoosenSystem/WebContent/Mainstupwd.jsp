...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<a href='Student.action?id=${stu.sid}&opttype=changepwd'><b>修改密码</b></a><br></br>
				<a href='LoginFrm.html'>安全退出</a>
				</div>
				<div id="main">
				<form action="Student.action?id=${stu.sid}" method="post" name="chpasswd" id="chpasswd">
				<input type=hidden name="opttype" value="dochangepwd">
					<br></br>
					<font size="4">您好！</font>
					<font size="4" color=#01814A >${stu.sname}</font>
