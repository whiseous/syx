...
<html>
	...
	function confirm()
	{
		location.href="Uniadmin.action?id=${uadmin.uid}&opttype=insertcoltutor"; 
	}
	</script>
	<meta charset="utf-8">
...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<input type=hidden name="opttype" value="reupcoltutor">
					<br></br>
								...
								<tbody>
									<c:forEach var="t" items="${tlist}" varStatus="status">
								       <tr bgcolor="${status.index % 2 == 1 ? 'FFFFFF' : 'F0F0F0'}">
								         ...
								         <td>${t.tsub}</td>
								         <td>
								            <a href='Uniadmin.action?id=${uadmin.uid}&tid=${t.tid}&opttype=addcol'>添加为院管理</a>
