...
<html>
	...
	{
		var a=alert("已更新导师信息！");
		location.href="Uniadmin.action?id=${uadmin.uid}&tid=${t.tid}&opttype=updatetutor"; 
	}
	</script>
	<meta charset="utf-8">
...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<div id="main">
				<form action="Uniadmin.action?id=${uadmin.uid}" method="post" name="upsetutor" id="upsetutor">
						...
						<div id="board">
							<table >
								...
								<tbody>
										...
										<tr class="info">
								         <td><b>姓名</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${t.tname}" name="uadtname"></td>
								         <td><b>性别</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${t.tgender}" name="uadtgender"></td>
								         
								      	</tr>
								       	
								       	<tr>
								       	<td><b>出生年月</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="${t.tbirth}" name="uadtbirth"></td>
										<td><b>最高学历</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="${t.tedu}" name="uadtedu"></td>
								       	</tr>
								       
								      	<tr class="info">
								         <td><b>职称</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${t.tjob}" name="uadtjob"></td>
								         <td><b>学科方向</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${t.tsub}" name="uadtsub"></td>
								      	</tr>
								      	
								      	<tr>
								         <td><b>导师类型</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${t.ttype}" name="uadttype"></td>
								         <td><b>所在学院</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${cname}" name="uadtcname"></td>
								         
								       	</tr>
								       	
								       	<tr class="info">
								         <td><b>办公电话</b></td>
								         <td><input class="itext" type="text" maxlength="50" value="${t.ttele}" name="uadttele"></td>
								         <td><b>电子邮件</b></td>
								         <td><input class="itext" type="text" maxlength="50" value="${t.tmail}" name="uadtmail"></td>
								      	</tr>
								      	
								      	<tr >
								         <td><b>导师编号</b></td>
								         <td><input class="itext" type="text" maxlength="50" value="${t.tid}" name="uadtid"></td>
								         <td><b>限制学生数</b></td>
								         <td><input class="itext" type="text" maxlength="50" value="${t.limit}" name="uadtlimit"></td>
								      	</tr>
								         ...
								         <td><b>研究方向或领域</b></td>
								      	...
								      	<tr>
								         <td colspan="4"><input class="ifieldtext" type="text" maxlength="50" value="${t.tfield}" name="uadtfield"></td>
								      	</tr>
								</tbody>
							</table>
							<button class="input" onclick="confirm();">更改信息</button>
							<button type="button" onclick="javascript:window.location.href='Uniadmin.action?id=${uadmin.uid}&opttype=selectshowtutor' " onsubmit='return false';>返回</button>
