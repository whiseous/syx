...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<a href='Teacher.action?id=${tea.tid}&opttype=changepwd'><b>修改密码</b></a><br></br>
				<a href='LoginFrm.html'>安全退出</a>
				</div>
				<div id="main">
				<form action="Teacher.action?id=${tea.tid}" method="post" name="chpasswd" id="chpasswd">
				<input type=hidden name="opttype" value="dochangepwd">
					<br></br>
					<font size="4">您好！</font>
					<font size="4" color=#01814A > ${tea.tname}</font>
					<font size="4">导师，请更改您的密码</font>
					<br></br>
					<div id="mainboard">
					<br></br>
						<div id="board" >
