...
<html>
	...
	{
		var a=alert("已更新学生信息！");
		location.href="Coladmin.action?id=${cadmin.tid}&tid=${t.tid}&opttype=updategrad"; 
	}
	</script>
	<meta charset="utf-8">
...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<div id="main">
				<form action="Coladmin.action?id=${cadmin.tid}" method="post" name="upsegrad" id="upsegrad">
						...
						<div id="board">
							<table >
								...
								<tbody>
										...
										<tr class="info">
								         <td><b>姓名</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${s.sname}" name="cadsname"></td>
								         <td><b>性别</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${s.sgender}" name="cadsgender"></td>
								         
								      	</tr>
								       	
								       	<tr>
								       	<td><b>学生编号</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="${s.sid}" name="cadsid"></td>
										<td><b>专业</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="${s.spro}" name="cadspro"></td>
								       	</tr>
								       
								      	<tr class="info">
								         <td><b>所在学院</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${cname}" name="cadscname"></td>
								         <td><b>分数</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="${s.sscore}" name="cadscore"></td>
								      	</tr>
								      	<tr>
								       	<td><b>最终导师</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="${fintname}" name="cadsfintutor"></td>
								       	</tr>
								</tbody>
							</table>
							<button class="input" onclick="confirm();">更改信息</button>
							<button type="button" onclick="javascript:window.location.href='Coladmin.action?id=${cadmin.tid}&opttype=selectshowgrad' " onsubmit='return false';>返回</button>
