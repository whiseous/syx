...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<div id="main">
					<br></br>
				<font size="4">欢迎您！导师：${tea.tname}，请阅读研究生导师双选系统导师流程</font>
				<br></br>
					<div id="mainboard">
					<br></br>
						<div id="board">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font size="3">进入系统登录界面并以导师的身份登录，登录时需输入导师编号及密码并输入正确的验证码。</font>
							<hr/>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font size="3">1).查看并选择自己所能教导学生数的学生;</font><br></br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font size="3">2).查看自己所选择的学生及其详细信息;</font><br></br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font size="3">3).查看最终确定要教导的学生:可以在系统开放时院级管理员确定后查看;</font><br></br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
