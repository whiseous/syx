		...
		<div id="wrapper">
			...
			<div id="container">
				...
				<input type=hidden name="opttype" value="reupgrad">
					<br></br>
				<font size="4">欢迎您！管理员：${uadmin.uid}，请输入需查询的相关学生信息</font><br></br>
								...
								<tbody>
									<c:forEach var="s" items="${slist}" varStatus="status">
								       <tr bgcolor="${status.index % 2 == 1 ? 'FFFFFF' : 'F0F0F0'}">
								         ...
								         <td>${s.spro}</td>
								         <td>
								         	<a href='Uniadmin.action?id=${uadmin.uid}&sid=${s.sid}&opttype=delegrad'>删除</a>
								            <a href='Uniadmin.action?id=${uadmin.uid}&sid=${s.sid}&opttype=viewgrad'>查看详细</a>
								         </td>
								       </tr>
								    </c:forEach>
								</tbody>
