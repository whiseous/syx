...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<a href='Coladmin.action?id=${cadmin.tid}&opttype=tutorin'><b>1.导师信息录入</b></a><br></br>
				...
				<div id="main">
				<form action="Uniadmin.action?id=${cadmin.tid}" method="post" name="insetutor" id="insetutor">
				<input type=hidden name="opttype" value="inserttutor">
					<br></br>
				<font size="4">欢迎您！管理员：${cadmin.tname}，请输入新增导师的信息</font>
				<br></br>
					<div id="mainboard">
					<br></br>
						<div id="board">
							<table >
								...
								<tbody>
										...
										<tr class="info">
								         <td><b>姓名</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="cadtname"></td>
								         <td><b>性别</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="cadtgender"></td>
								         
								      	</tr>
								       	
								       	<tr>
								       	<td><b>出生年月</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="" name="cadtbirth"></td>
										<td><b>最高学历</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="" name="cadtedu"></td>
								       	</tr>
								       
								      	<tr class="info">
								         <td><b>职称</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="cadtjob"></td>
								         <td><b>学科方向</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="cadtsub"></td>
								      	</tr>
								      	
								      	<tr>
								         <td><b>导师类型</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="cadttype"></td>
								         <td><b>所在学院</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="cadtcname"></td>
								         
								       	</tr>
								       	
								       	<tr class="info">
								         <td><b>办公电话</b></td>
								         <td><input class="itext" type="text" maxlength="50" value="" name="cadttele"></td>
								         <td><b>电子邮件</b></td>
								         <td><input class="itext" type="text" maxlength="50" value="" name="cadtmail"></td>
								      	</tr>
								      	
								      	<tr >
								         <td><b>导师编号</b></td>
								         <td><input class="itext" type="text" maxlength="50" value="" name="cadtid"></td>
								         <td><b>限制学生数</b></td>
								         <td><input class="itext" type="text" maxlength="50" value="" name="cadtlimit"></td>
								      	</tr>
								         ...
								         <td><b>研究方向或领域</b></td>
								      	...
								      	<tr>
								         <td colspan="4"><input class="ifieldtext" type="text" maxlength="50" value="" name="cadtfield"></td>
								      	</tr>
								</tbody>
							</table>
