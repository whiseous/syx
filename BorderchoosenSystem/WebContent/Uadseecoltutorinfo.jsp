...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<a href='Uniadmin.action?id=${uadmin.uid}&opttype=selectcoadmin'><b>2.维护院级管理员</b></a><br></br>
								...
								<tbody>
								        ...
								        <td>${t.tedu}</td>
								         ...
								         <td><b>研究方向或领域</b></td>
								      	...
								      	<tr>
								         <td colspan="4">${t.tfield}</td>
								      	</tr>
								</tbody>
							</table>
							<button class="input" type="button" onclick="javascript:window.location.href='Uniadmin.action?id=${uadmin.uid}&opttype=selectcoadmin' " onsubmit='return false';>返回</button>
