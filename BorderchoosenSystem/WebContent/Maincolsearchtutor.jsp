...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<div id="main">
				<form action="Coladmin.action?id=${cadmin.tid}" method="post" name="uaduptutor" id="uaduptutor">
				<input type=hidden name="opttype" value="reuptutor">
					<br></br>
				<font size="4">欢迎您！管理员：${cadmin.tname}，请输入需查询的相关导师信息</font><br></br>
								...
								<tbody>
									<c:forEach var="t" items="${tlist}" varStatus="status">
								       <tr bgcolor="${status.index % 2 == 1 ? 'FFFFFF' : 'F0F0F0'}">
								         ...
								         <td>${t.tsub}</td>
								         <td>
								            <a href='Coladmin.action?id=${cadmin.tid}&tid=${t.tid}&opttype=deletutor'>删除</a>
								            <a href='Coladmin.action?id=${cadmin.tid}&tid=${t.tid}&opttype=viewtutor'>查看详细</a>
								         </td>
								       </tr>
								    </c:forEach>
								</tbody>
