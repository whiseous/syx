...
<html>
	...
	function confirm()
	{
		location.href="Uniadmin.action?id=${uadmin.uid}&opttype=insertgrad"; 
	}
	</script>
	<meta charset="utf-8">
...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<a href='Uniadmin.action?id=${uadmin.uid}&opttype=graduin'><b>1.研究生信息录入</b></a><br></br>
				...
				<div id="main">
				<form action="Uniadmin.action?id=${uadmin.uid}" method="post" name="insegrad" id="insegrad">
				<input type=hidden name="opttype" value="insertgrad">
					<br></br>
				<font size="4">欢迎您！管理员：${uadmin.uid}，请输入新增学生的信息</font>
				<br></br>
					<div id="mainboard">
					<br></br>
						<div id="board">
							<table >
								...
								<tbody>
										...
										<tr class="info">
								         <td><b>姓名</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="uadsname"></td>
								         <td><b>性别</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="uadsgender"></td>
								         
								      	</tr>
								       	
								       	<tr>
								       	<td><b>学生编号</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="" name="uadsid"></td>
										<td><b>专业</b></td>
								        <td><input class="itext" type="text" maxlength="10" value="" name="uadspro"></td>
								       	</tr>
								       
								      	<tr class="info">
								         <td><b>所在学院</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="uadscname"></td>
								         <td><b>分数</b></td>
								         <td><input class="itext" type="text" maxlength="10" value="" name="uadscore"></td>
								      	</tr>
