...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<a href='bteller.action?id=${bteller.eid}&opttype=SERVICE_DEPOSIT_LIVE'><b>1.活期存款</b></a><br></br>
				...
				<input type=hidden name="deposittype" value="live">
					<br></br>
								...
								<tbody>
										<tr class="info">
								         ...
								         <td><input class="itext" type="text" maxlength="40" value="" name="custname"></td>
								       	...
								       	<tr>
										<td><b>金额</b></td>
								         <td><input class="itext" type="text" maxlength="40" value="" name="amount"></td>
								       	</tr>
								        ...
								        <td><input type="hidden" id="txtDate" value="0000-00-00" name="endtime" /></td>
								      	</tr>
