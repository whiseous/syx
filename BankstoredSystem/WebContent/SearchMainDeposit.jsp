...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<input type=hidden name="opttype" value="reupdeposit">
					<br></br>
				<font size="4">欢迎您！业务员：${bteller.eid}，请输入需查询的相关存款信息</font><br></br>
								...
								<tbody>
									<c:forEach var="s" items="${slist}" varStatus="status">
								       <tr bgcolor="${status.index % 2 == 1 ? 'FFFFFF' : 'F0F0F0'}">
								         ...
								         <td>${s.drecord.amount}</td>
								         <td>${s.drecord.rate}</td>
								         <td>
								            <a href='bteller.action?id=${bteller.eid}&uid=${s.user.uid}&utime=${s.drecord.depositdate}&opttype=viewdeposit'>取钱</a>
								         </td>
								       </tr>
								    </c:forEach>
								</tbody>
