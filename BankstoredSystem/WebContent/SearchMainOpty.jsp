...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<a href='bteller.action?id=${bteller.eid}&opttype=SERVICE_PRINT_HISTORY'><b>2.用户历史记录</b></a><br></br>
				...
				<input type=hidden name="opttype" value="reupprintopty">
					<br></br>
				<font size="4">欢迎您！业务员：${bteller.eid}，请输入需查询的相关操作信息</font><br></br>
