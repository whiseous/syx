...
<html>
	...
	if(conti=='1')
	{
		...
		{
		alert("储户${user.username}的储户ID为${user.uid}")
		}
...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<a href='Loginbstore.action?account=${bteller.account}&pwd=${bteller.password}&identity=bankteller'><b>●存款业务</b></a><br></br>
				...
				<div id="main">
				<form action="bteller.action?id=${bteller.eid}" method="post" name="insecustomer" id="insecustomer">
				<input type=hidden name="opttype" value="insertcustomer">
					<br></br>
				<font size="4">欢迎您！业务员：${bteller.eid}，请输入新增储户信息</font>
				<br></br>
					<div id="mainboard">
					<br></br>
						<div id="board">
							<table >
								<thead>
									<tr>
										<th colspan="6">储户信息</th>
									</tr>
								</thead>
								<tbody>
										<tr class="info">
								         <td><b>姓名</b></td>
								         <td><input class="itext" type="text" maxlength="40" value="" name="custname"></td>
								      	</tr>
								       	
								       	<tr>
										<td><b>地址</b></td>
								         <td><input class="itext" type="text" maxlength="40" value="" name="address"></td>
								       	</tr>
				      	
								</tbody>
							</table>
							<button class="input" onclick="confirm();">添加储户信息</button>
