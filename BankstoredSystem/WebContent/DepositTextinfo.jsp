...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<input type=hidden name="opttype" value="printdeposit">
					<br></br>
					...
					<br></br>
						<div id="board">
							...
							<button type="button" onclick="javascript:window.location.href='bteller.action?id=${bteller.eid}&detype=${d.depositype}&opttype=back_deposit' " onsubmit='return false';>返回</button>
