...
<body>
		<div id="wrapper">
			...
			<div id="container">
				...
				<input type=hidden name="opttype" value="printbenefit">
					<br></br>
					<font size="4">您好！此为储户</font>
					<font size="4" color=#01814A >${u.username}</font>
					<font size="4">的${d.depositype}利息单</font>
					<br></br>
					<div id="mainboard">
					<br></br>
						<div id="board">
							<table >
								...
								<tbody>
								        ...
								        <td><input class="itext" type="text" maxlength="10"  value="${d.rate}" name="rate" readonly></td>
								         ...
								         <td><b>取款日期</b></td>
								         <td><input class="itext" type="text" maxlength="10"  value="${b.withdrawdate}" name="date" readonly></td>
								      	</tr>
								      	
								      	<tr>
								         <td><b>总金额</b></td>
								         <td colspan="4"><input class="itext" type="text" maxlength="10"  value="${b.withdraw+b.wdbenefit}" name="all"></td>
								      	</tr>
								</tbody>
							</table>
							<button class="input" onclick="confirm();">打印</button>
							<button type="button" onclick="javascript:window.location.href='bteller.action?id=${bteller.eid}&uid=${u.uid}&utime=${d.depositdate}&opttype=viewdeposit' " onsubmit='return false';>返回</button>
							<font style="color:grey">注：超时或未存满定期，则未存满定期与超时部分利率为原利率1/30</font>
						</div>	
					</div>	
					</form>		
